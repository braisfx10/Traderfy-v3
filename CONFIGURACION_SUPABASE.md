...
2. En **Site URL**, agrega: `https://tradepulse-76.preview.emergentagent.com`
3. En **Redirect URLs**, agrega estas URLs (una por línea):
   ```
   https://tradepulse-76.preview.emergentagent.com/**
   https://tradepulse-76.preview.emergentagent.com/auth/callback
   http://localhost:3000/**

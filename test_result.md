...
agent_communication:
  ...
  - task: "Fix Duplicate Trades & Undefined Error"
    ...
    - agent: "main"
    - message: "CRITICAL FIXES COMPLETED: Successfully resolved duplicate trades issue (55 trades instead of 110, $1,999.35 profit correct) and undefined error in UI upload. Parser now processes only first valid historial table, preventing duplicates. Added robust error handling for UI compatibility. All metrics now accurate: Win Rate 74.55%, Recovery Factor 371, Max Drawdown 5.39%. Ready for production use."
    - agent: "main"
